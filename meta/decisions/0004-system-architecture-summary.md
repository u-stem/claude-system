...
- 第三者向けの汎用テンプレートではなく、特定の作業環境を前提に最適化されている旨を README に明示
...
| **claude-system 自身を Issue 駆動運用**(GitHub Issues / Projects / Discussions) | 保留 | 単独運用のため Issue 駆動はオーバーヘッドが大きい可能性。v0.2 検討材料として `meta/TODO-for-v0.2.md` に記録 |
